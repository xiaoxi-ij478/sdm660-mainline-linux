...
static inline
struct nt51021_boe_10wu_wuxga *to_nt51021_boe_10wu_wuxga(struct drm_panel *panel)
{
	return container_of(panel, struct nt51021_boe_10wu_wuxga, panel);
}

static void nt51021_boe_10wu_wuxga_reset(struct nt51021_boe_10wu_wuxga *ctx)
{
	gpiod_set_value_cansleep(ctx->reset_gpio, 0);
	usleep_range(10000, 11000);
}

static int nt51021_boe_10wu_wuxga_on(struct nt51021_boe_10wu_wuxga *ctx)
{
...
static int nt51021_boe_10wu_wuxga_off(struct nt51021_boe_10wu_wuxga *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
	struct device *dev = &dsi->dev;
	int ret;
...
static int nt51021_boe_10wu_wuxga_prepare(struct drm_panel *panel)
{
	struct nt51021_boe_10wu_wuxga *ctx = to_nt51021_boe_10wu_wuxga(panel);
	...
	nt51021_boe_10wu_wuxga_reset(ctx);

	ret = nt51021_boe_10wu_wuxga_on(ctx);
	if (ret < 0) {
...
static int nt51021_boe_10wu_wuxga_unprepare(struct drm_panel *panel)
{
	struct nt51021_boe_10wu_wuxga *ctx = to_nt51021_boe_10wu_wuxga(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
	...
	ret = nt51021_boe_10wu_wuxga_off(ctx);
	if (ret < 0)
...
static const struct drm_display_mode nt51021_boe_10wu_wuxga_mode = {
...
static int nt51021_boe_10wu_wuxga_get_modes(struct drm_panel *panel,
					    struct drm_connector *connector)
{
	struct drm_display_mode *mode;

	mode = drm_mode_duplicate(connector->dev, &nt51021_boe_10wu_wuxga_mode);
	if (!mode)
		return -ENOMEM;
...
static const struct drm_panel_funcs nt51021_boe_10wu_wuxga_panel_funcs = {
	.prepare = nt51021_boe_10wu_wuxga_prepare,
	.unprepare = nt51021_boe_10wu_wuxga_unprepare,
	.get_modes = nt51021_boe_10wu_wuxga_get_modes,
};

static int nt51021_boe_10wu_wuxga_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct nt51021_boe_10wu_wuxga *ctx;
	int ret;
	...
	drm_panel_init(&ctx->panel, dev, &nt51021_boe_10wu_wuxga_panel_funcs,
...
static void nt51021_boe_10wu_wuxga_remove(struct mipi_dsi_device *dsi)
{
	struct nt51021_boe_10wu_wuxga *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id nt51021_boe_10wu_wuxga_of_match[] = {
	{ .compatible = "boe,nt51021-10wu" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, nt51021_boe_10wu_wuxga_of_match);

static struct mipi_dsi_driver nt51021_boe_10wu_wuxga_driver = {
	.probe = nt51021_boe_10wu_wuxga_probe,
	.remove = nt51021_boe_10wu_wuxga_remove,
	.driver = {
		.name = "panel-nt51021-boe-10wu-wuxga",
		.of_match_table = nt51021_boe_10wu_wuxga_of_match,
	},
};
module_mipi_dsi_driver(nt51021_boe_10wu_wuxga_driver);
