 ...
 * and, as for the others, it docuemnts 0x4053, 0x5e54 and 0x5e59.. and
 * nothing else.
 *
 ...
 * day they get documented somehow, or a use for them gets found.
 */
...
static const struct imx219_reg mode_1640x1232_x2_digital_binning[] = {
	/* This resolution works only in 2-lane mode */
	{ IMX219_REG_FRAME_LEN_LINES, 1346, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_LINE_LEN_PCK, 3448, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_X_ADDR_START, 0, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_X_ADDR_END, 3279, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_Y_ADDR_START, 0, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_Y_ADDR_END, 2463, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_X_OUTPUT_SIZE, 1640, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_Y_OUTPUT_SIZE, 1232, IMX219_REG_VALUE_16BIT, true },
	{ IMX219_REG_X_ODD_INC, 1, IMX219_REG_VALUE_08BIT, true },
	{ IMX219_REG_Y_ODD_INC, 1, IMX219_REG_VALUE_08BIT, true },
	{ IMX219_REG_BINNING_MODE_H, 1, IMX219_REG_VALUE_08BIT, true },
	{ IMX219_REG_BINNING_MODE_V, 1, IMX219_REG_VALUE_08BIT, true },
	{ IMX219_REG_BINNING_CAL_H, 0, IMX219_REG_VALUE_08BIT, true },
	{ IMX219_REG_BINNING_CAL_V, 0, IMX219_REG_VALUE_08BIT, true },
};
...
static const struct imx219_mode supported_modes[] = {
	...
	},
	{
		...
		.reg_list = {
			.num_of_regs =
				ARRAY_SIZE(mode_1640x1232_x2_digital_binning),
			.regs = mode_1640x1232_x2_digital_binning,
		},
	},
	{
		/* 720P 120fps cropped */
