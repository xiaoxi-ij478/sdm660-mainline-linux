...
REG(IPA_BCR, ipa_bcr, 0x000005b0);

REG(ENABLED_PIPES, enabled_pipes, 0x000005dc);
...
REG_FIELDS(COUNTER_CFG, counter_cfg, 0x000005e8);
...
static const struct reg *reg_array[] = {
	...
	[IPA_BCR]			= &reg_ipa_bcr,
	[ENABLED_PIPES]			= &reg_enabled_pipes,
...
const struct regs ipa_regs_v2_6l = {
