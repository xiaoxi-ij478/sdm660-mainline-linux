...
/* sdm660 */
DEFINE_CLK_SMD_RPM_BRANCH(sdm660, cxo, cxo_a, QCOM_SMD_RPM_MISC_CLK, 0, 19200000);
...
DEFINE_CLK_SMD_RPM(sdm660, cnoc_periph_clk, cnoc_periph_a_clk, QCOM_SMD_RPM_BUS_CLK, 0);
DEFINE_CLK_SMD_RPM(sdm660, bimc_clk, bimc_a_clk, QCOM_SMD_RPM_MEM_CLK, 0);
DEFINE_CLK_SMD_RPM(sdm660, mmssnoc_axi_clk, mmssnoc_axi_a_clk, QCOM_SMD_RPM_MMAXI_CLK, 0);
...
DEFINE_CLK_SMD_RPM(sdm660, aggre2_noc_clk, aggre2_noc_a_clk, QCOM_SMD_RPM_AGGR_CLK, 2);
DEFINE_CLK_SMD_RPM_QDSS(sdm660, qdss_clk, qdss_a_clk, QCOM_SMD_RPM_MISC_CLK, 1);
...
DEFINE_CLK_SMD_RPM_XO_BUFFER_PINCTRL(sdm660, ln_bb_clk1_pin, ln_bb_clk1_pin_ao, 0x1);
DEFINE_CLK_SMD_RPM_XO_BUFFER_PINCTRL(sdm660, ln_bb_clk2_pin, ln_bb_clk2_pin_ao, 0x2);
DEFINE_CLK_SMD_RPM_XO_BUFFER_PINCTRL(sdm660, ln_bb_clk3_pin, ln_bb_clk3_pin_ao, 0x3);

static struct clk_smd_rpm *sdm660_clks[] = {
	[RPM_SMD_XO_CLK_SRC]		= &sdm660_cxo,
	[RPM_SMD_XO_A_CLK_SRC]		= &sdm660_cxo_a,
	...
	[RPM_SMD_RF_CLK1_A]		= &sdm660_rf_clk1_ao,
	[RPM_SMD_RF_CLK1_PIN]		= &sdm660_rf_clk1_pin,
	[RPM_SMD_RF_CLK1_A_PIN]		= &sdm660_rf_clk1_ao_pin,
	...
	[RPM_SMD_DIV_A_CLK1]		= &sdm660_div_clk1_ao,
	[RPM_SMD_LN_BB_CLK1]		= &sdm660_ln_bb_clk1,
	[RPM_SMD_LN_BB_CLK1]		= &sdm660_ln_bb_clk1_ao,
	[RPM_SMD_LN_BB_CLK1_PIN]	= &sdm660_ln_bb_clk1_pin,
	[RPM_SMD_LN_BB_CLK1_PIN_A]	= &sdm660_ln_bb_clk1_pin_ao,
	[RPM_SMD_LN_BB_CLK2]		= &sdm660_ln_bb_clk2,
	[RPM_SMD_LN_BB_CLK2_A]		= &sdm660_ln_bb_clk2_ao,
	[RPM_SMD_LN_BB_CLK2_PIN]	= &sdm660_ln_bb_clk2_pin,
	[RPM_SMD_LN_BB_CLK2_PIN_A] 	= &sdm660_ln_bb_clk2_pin_ao,
	[RPM_SMD_LN_BB_CLK3]		= &sdm660_ln_bb_clk3,
	[RPM_SMD_LN_BB_CLK3_A]		= &sdm660_ln_bb_clk3_ao,
	[RPM_SMD_LN_BB_CLK3_PIN]	= &sdm660_ln_bb_clk3_pin,
	[RPM_SMD_LN_BB_CLK3_A_PIN] 	= &sdm660_ln_bb_clk3_pin_ao,
